...
export function MyHeader(props:{active: string}) {
    ...
    <header role="header" className={classes.header}>
      ...
      <div className={classes.menu_container}>
        <h1 id='posts' className={props.active === 'post'? classes.active : classes.h1} onClick={ pathCheck }>Posts Page</h1>
        <h1 id='about' className={props.active === 'about'? classes.active : classes.h1} onClick={ pathCheck }>About Us</h1>
        <h1 id='orders' className={props.active === 'orders'? classes.active : classes.h1} onClick={ pathCheck }>Orders</h1>
      </div>
